...
class des():
    ...
    def run_cbc(self, key, text, action=ENCRYPT, padding=True,IV='ASASASAS'):
    ...
    def substitute(self, d_e):#Substitute bytes using SBOX
        ...
        result = []
        i = 0
        for sixbit in subblocks:
            sboxVal = self.compute_s_box(sixbit, i)
            for k in sboxVal:
                result.append(int(k))
                #print(result)
            i+=1
    ...
    def permut(self, block, table):#Permut the given block using the given table (so generic method)
        ...
        tempBlock = [None]*len(table)
        i=0
        for index in table:
            #print("next Block")
            #print(block)
            tempBlock[i] = block[index-1]
            i=i+1
        return tempBlock
    ...
    def compute_s_box(self,block,round):
        ...
        #print("Column:")
        #print(column)
        #print(S_BOX[round % 8][row][column])
        n = S_BOX[round % 8][row][column]
        #print("before bin replacement")
        #print(n)
        #print("What was subbed:")
        #print(format(n, '004b'))
...
#ABC = des()
#boop = ABC.encrypt('secret_k','aaaabbbbasdfdasfdsfsafsafasfsda')
#print(boop)
#boop = ABC.decrypt('secret_k',boop)
#print(boop)
